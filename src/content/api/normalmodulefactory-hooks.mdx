...
6. `asset/resource`
7. `asset/inline`
for better building of website use
nextjs: for planning better solution to issues ahead of time after getting a perfect solution 
if failed wait and try solving issues
